unit checkliveevent_module;

interface
  uses
  classes,sysutils, globalfunc, olimpbase_module, navlive_module, navlivechamp_module,
  ...
  procedure check;
  procedure changechamp(oldid,newid:integer);
  constructor create;
...
procedure checkliveevent_class.changechamp(oldid, newid: integer);
var
sqlstr:string;
begin
sqlstr:='changechamp '+inttostr(oldid)+','+inttostr(newid)+';';
  wwdb.setval(sqlstr);
end;
